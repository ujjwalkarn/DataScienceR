...
##more()
more() is a user-defined function that is helpful in printing out a large object.
...
```
Taken from [here](http://stackoverflow.com/questions/21610468/pause-print-of-large-object-when-it-fills-the-screen)
